...
path_to_fg_images='d:\Matlab\Xray_Talbot_Interferometry\XTI_dph_abs_vis_image_calculator_sinus_fitting_CPU\';
% path to background images
path_to_bg_images='d:\Matlab\Xray_Talbot_Interferometry\XTI_dph_abs_vis_image_calculator_sinus_fitting_CPU\';
% path to output folder to save final differentila phase image
path_to_output_folder='d:\Matlab\Xray_Talbot_Interferometry\XTI_dph_abs_vis_image_calculator_sinus_fitting_CPU\';
...
%**************************************************************************
% initialize additional two kinds of images evaluated in X-ray Talbot
% interferometry
%**************************************************************************
% absorbtion image
%**************************************************************************
% phase image for forground
abs_image_fg=zeros(image_size_rows, image_size_cols);
% phase image for background
abs_image_bg=zeros(image_size_rows, image_size_cols);
% initiliaze differential phase image
abs_image=zeros(image_size_rows, image_size_cols);
%**************************************************************************
% visibility_image
%**************************************************************************
vis_image_fg=zeros(image_size_rows, image_size_cols);
% phase image for background
vis_image_bg=zeros(image_size_rows, image_size_cols);
% initiliaze differential phase image
...
for index_0=1:image_size_rows
    for index_1=1:image_size_cols
        ...
        abs_image_fg(index_0,index_1)=fit_result(1,3);
        vis_image_fg(index_0,index_1)=fit_result(1,1)/fit_result(1,3);
        %toc
    end
end
toc
...
for index_0=1:image_size_rows
    for index_1=1:image_size_cols
        ...
        abs_image_bg(index_0,index_1)=fit_result(1,3);
        vis_image_bg(index_0,index_1)=fit_result(1,1)/fit_result(1,3);
        %toc
    end
end
toc
...
abs_image=abs_image_fg(:,:)./abs_image_bg(:,:);
...
fclose(fileID);
%**************************************************************************
% calculate final visibility image
vis_image=vis_image_fg(:,:)./vis_image_bg(:,:);
...
% save visibility image as 64bit real image with little bit endian
% ordering
